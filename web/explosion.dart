...
class Explosion extends Zei.GameObject {
  ...
  Explosion(Zei.Vector2 position) {
    sprite = Zei.Sprite.create("buffer", "explosion", Zei.images["explosion"], position, 64, 64, animated: true, animationFPS: 30, anchor: new Zei.Vector2(0.5, 0.5), rotation: Zei.randomInt(0, 359));
  }
