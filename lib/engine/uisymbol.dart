...
class UISymbol {
  ...
  void draw() {
    ...
    context
      ...
      ..font = '10px'
      ..textAlign = 'center'
      ..fillText(building.type.substring(0, 1).toUpperCase() + building.type.substring(1), rectangle.left + (rectangle.width / 2), rectangle.top + 15) // name
      ..textAlign = 'left'
      ..fillText("(${new String.fromCharCode(keyCode)})", rectangle.left + 5, rectangle.top + 50) // keycode
      ..textAlign = 'right'
      ..fillText(building.maxHealth.toString(), rectangle.left + rectangle.width - 5, rectangle.top + 50); // required packets
  }
