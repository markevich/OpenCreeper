...
function dart_precompiled($collectedClasses) {
  ...
  function Layer(_creeper$_value) {
    this._creeper$_value = _creeper$_value;
  }
  ...
  function Mouse(position, active, buttonPressed, dragStart) {
    this.position = position;
    this.active = active;
  ...
  function Game(tileSize, seed, terraformingHeight, speed, zoom, running, mode, paused, won, ghosts, world, scroll, mouseScrolling, keyScrolling, oldHoveredTile, hoveredTile, stopwatch, tfLine1, tfLine2, tfLine3, tfLine4, tfNumber, targetCursor) {
    ...
    this.oldHoveredTile = oldHoveredTile;
