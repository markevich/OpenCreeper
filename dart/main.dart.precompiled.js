...
function dart_precompiled($collectedClasses) {
  ...
  function Building(position, scale, moveTargetPosition, weaponTargetPosition, speed, type, status, operating, selected, hovered, built, active, canMove, needsEnergy, rotating, health, maxHealth, energy, maxEnergy, healthRequests, energyRequests, rotation, targetAngle, weaponRadius, size, collectedEnergy, flightCounter, requestCounter, energyCounter, ship, sprite, cannon, selectedCircle, targetSymbol) {
    this.position = position;
    this.scale = scale;
  ...
  Building.prototype.get$operating = function() {
  ...
  Building.prototype.set$hovered = function(v) {
    return this.hovered = v;
  };
  ...
  Building.prototype.get$canMove = function() {
    return this.canMove;
  };
  Building.prototype.get$needsEnergy = function() {
    return this.needsEnergy;
  };
  Building.prototype.set$rotating = function(v) {
    return this.rotating = v;
  };
  Building.prototype.get$health = function() {
    return this.health;
  };
  Building.prototype.get$maxHealth = function() {
    return this.maxHealth;
  };
  Building.prototype.get$energy = function() {
    return this.energy;
  };
  Building.prototype.get$maxEnergy = function() {
    return this.maxEnergy;
  };
  Building.prototype.get$weaponRadius = function() {
    return this.weaponRadius;
  };
  Building.prototype.get$size = function(receiver) {
    return this.size;
  };
  Building.prototype.get$selectedCircle = function() {
    return this.selectedCircle;
  };
  Building.prototype.get$targetSymbol = function() {
    return this.targetSymbol;
  };
  function Connection(from, to, line, line2) {
    this.from = from;
    this.to = to;
    this.line = line;
    this.line2 = line2;
  ...
  Connection.prototype.get$from = function() {
    return this.from;
  };
  Connection.prototype.get$to = function() {
    return this.to;
  };
  Connection.prototype.get$line2 = function() {
    return this.line2;
  };
  function DisplayObject(visible) {
  ...
  function Rect(position, size, lineWidth, color, anchor, layer, visible) {
    this.position = position;
    this.size = size;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Rect.prototype = $desc;
  Rect.prototype.get$position = function(receiver) {
    return this.position;
  };
  Rect.prototype.set$position = function(receiver, v) {
    return this.position = v;
  };
  Rect.prototype.get$size = function(receiver) {
    return this.size;
  };
  function Circle(position, radius, lineWidth, color, scale, layer, visible) {
    this.position = position;
    this.radius = radius;
    this.lineWidth = lineWidth;
    this.color = color;
  ...
  Circle.prototype.get$position = function(receiver) {
    return this.position;
  };
  function Line(color, from, to, lineWidth, layer, visible) {
    this.color = color;
    this.from = from;
    this.to = to;
    this.lineWidth = lineWidth;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Line.prototype = $desc;
  Line.prototype.get$from = function() {
    return this.from;
  };
  Line.prototype.get$to = function() {
    return this.to;
  };
  function Sprite(frame, image, anchor, scale, position, size, rotation, alpha, animated, layer, visible) {
    this.frame = frame;
    this.image = image;
    this.anchor = anchor;
    this.scale = scale;
  ...
  Sprite.prototype.set$position = function(receiver, v) {
    return this.position = v;
  };
  Sprite.prototype.get$size = function(receiver) {
    return this.size;
  };
  function Layer(_value) {
    this._value = _value;
  }
  Layer.builtin$cls = "Layer";
  if (!"name" in Layer)
    Layer.name = "Layer";
  $desc = $collectedClasses.Layer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Layer.prototype = $desc;
  Layer.prototype.get$_value = function() {
    return this._value;
  };
  ...
  function Mouse(position, active, buttonPressed, dragStart, dragEnd) {
    this.position = position;
    this.active = active;
  ...
  Mouse.prototype.get$position = function(receiver) {
    return this.position;
  };
  Mouse.prototype.get$active = function() {
    return this.active;
  };
  Mouse.prototype.set$active = function(v) {
    return this.active = v;
  };
  function Engine(animationRequest, TPS, width, height, halfWidth, halfHeight, mouse, renderer, sounds, images, resizeTimer) {
  ...
  function Engine_setupEventHandler_closure14() {
  }
  Engine_setupEventHandler_closure14.builtin$cls = "Engine_setupEventHandler_closure14";
  if (!"name" in Engine_setupEventHandler_closure14)
    Engine_setupEventHandler_closure14.name = "Engine_setupEventHandler_closure14";
  $desc = $collectedClasses.Engine_setupEventHandler_closure14;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Engine_setupEventHandler_closure14.prototype = $desc;
  function Engine_setupEventHandler_closure15() {
  }
  Engine_setupEventHandler_closure15.builtin$cls = "Engine_setupEventHandler_closure15";
  if (!"name" in Engine_setupEventHandler_closure15)
    Engine_setupEventHandler_closure15.name = "Engine_setupEventHandler_closure15";
  $desc = $collectedClasses.Engine_setupEventHandler_closure15;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Engine_setupEventHandler_closure15.prototype = $desc;
  ...
  function Game(tileSize, seed, terraformingHeight, speed, creeperCounter, zoom, running, mode, paused, creeperDirty, won, ghosts, world, scroll, mouseScrolling, keyScrolling, stopwatch, tfLine1, tfLine2, tfLine3, tfLine4, tfNumber, targetCursor) {
    ...
    this.mode = mode;
    this.paused = paused;
    this.creeperDirty = creeperDirty;
    this.won = won;
    this.ghosts = ghosts;
    this.world = world;
    this.scroll = scroll;
  ...
  function Packet(speed, type, remove, speedMultiplier, target, currentTarget, sprite) {
    this.speed = speed;
    this.type = type;
    this.remove = remove;
  ...
  Packet.prototype.get$type = function(receiver) {
    return this.type;
  };
  function Packet_findRoute_closure() {
  }
  Packet_findRoute_closure.builtin$cls = "Packet_findRoute_closure";
  if (!"name" in Packet_findRoute_closure)
    Packet_findRoute_closure.name = "Packet_findRoute_closure";
  $desc = $collectedClasses.Packet_findRoute_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Packet_findRoute_closure.prototype = $desc;
  function Projectile(targetPosition, speed, remove, sprite) {
  ...
  function Renderer(view, context, top, left, bottom, right, layers) {
    this.view = view;
  ...
  function Ship(speed, targetPosition, type, status, remove, hovered, selected, maxEnergy, energy, trailCounter, weaponCounter, flightCounter, home, sprite, targetSymbol, selectedCircle) {
    this.speed = speed;
    this.targetPosition = targetPosition;
    this.type = type;
    this.status = status;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ship.prototype = $desc;
  Ship.prototype.get$type = function(receiver) {
    return this.type;
  };
  ...
  Ship.prototype.set$hovered = function(v) {
    return this.hovered = v;
  };
  ...
  Ship.prototype.get$maxEnergy = function() {
    return this.maxEnergy;
  };
  Ship.prototype.get$energy = function() {
    return this.energy;
  };
  Ship.prototype.get$targetSymbol = function() {
    return this.targetSymbol;
  };
  Ship.prototype.get$selectedCircle = function() {
    return this.selectedCircle;
  };
  ...
  Spore.prototype.get$health = function() {
    return this.health;
  };
  ...
  UISymbol.prototype.get$active = function() {
    return this.active;
  };
  UISymbol.prototype.set$active = function(v) {
    return this.active = v;
  };
  UISymbol.prototype.get$hovered = function() {
    return this.hovered;
  };
  UISymbol.prototype.set$hovered = function(v) {
    return this.hovered = v;
  };
  function Vector(x, y) {
    this.x = x;
  ...
  function Tile(creep, newcreep, collector, height, index, terraformTarget, terraformProgress, terraformNumber) {
    this.creep = creep;
    ...
    this.terraformNumber = terraformNumber;
  }
